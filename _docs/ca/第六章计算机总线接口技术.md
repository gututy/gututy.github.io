...
- 基本连接单元
  - buffer
   ![buffer](./第六章图/片上总线_单元1.png)
  - mux
   ![mux](./第六章图/片上总线_单元2.png)

![点对点式的共享信号链接](./第六章图/片上总线_点对点.png)
...
![APB总线](./第六章图/APB总线.png)

  - 固定时序，不支持突发
  - 没有数据握手，无法插入等待周期
  - 接口简单易实现

![APB总线写](./第六章图/APB总线写.png)
写

![APB总线读](./第六章图/APB总线读.png)
读
...
![AHB总线1](./第六章图/AHB总线1.png)

![AHB总线2](./第六章图/AHB总线2.png)
...
![AXI架构](./第六章图/AXI架构.png)

#### 事务示例
- 读

![AXI读](./第六章图/AXI事务_读.png)

- 重叠读

![AXI重叠读](./第六章图/AXI事务_重叠读.png)

- 写

![AXI写](./第六章图/AXI事务_写.png)
