...
![段页式存储管理](/assets/ca/第二章图/段页式存储管理.png)
...
- LoongArch的虚拟机层次
  ...
  ![LoongArch各级别可访问资源](/assets/ca/第二章图/LoongArch各级别可访问资源.png)
...
![经不经过Cache](/assets/ca/第二章图/经不经过Cache.png)
...
![指令格式比较](/assets/ca/第二章图/指令格式比较.png)

## 寻址方式比较

![寻址方式比较](/assets/ca/第二章图/寻址方式比较.png)
