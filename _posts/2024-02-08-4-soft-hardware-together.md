...
title: 软硬件协同
tags: 计算机体系结构 学习笔记
permalink: /notes/ca/soft-hardware-together
aside:
    toc: ture
sidebar:
    nav: notes
...
![MIPS_ABI寄存器约定](/assets/ca/第四章图/mips_abi寄存器.png)
...
![Loong_Arch寄存器约定](/assets/ca/第四章图/LoongArch_ABI寄存器.png)
...
![LoongArch参数传递](/assets/ca/第四章图/LoongArch参数传递.png)
